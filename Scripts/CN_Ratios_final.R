...
lit <- 
  ...
  filter(Outlier == "TRUE" & Trait != "Leaf piercers") #not enough piercers
...
Trait<-tibble(Trait = c("Leaf chewers", 
                         "Micro-invertebrates","Macro-invertebrates",
                        "Ambush hunters", "Bioturbators", 
                        "Detritus grazers", "Detritus shredders", 
                        "Hunting predators", "Leaf piercers"))

Function<-tibble(Function = c("Herbivores", 
                              "Body size", "Body size",
